...
Patch1001: FED01-Soften-dependencies.patch

# The cache file belongs in /var/cache according to guidelines
Patch1002: FED02-Change-default-paths-to-match-Fedora-policies.patch
...
# Create directory for installed sites
mkdir -p $RPM_BUILD_ROOT/%{_sharedstatedir}/reviewboard/sites
...
%dir %{_sharedstatedir}/reviewboard
%dir %{_sharedstatedir}/reviewboard/sites
...
* Fri Feb 20 2015 Stephen Gallagher <sgallagh@redhat.com> 2.0.13-2
...
* Wed Oct 03 2012 Stephen Gallagher <sgallagh@redhat.com> - 1.7-2.beta2
...
* Mon Aug 06 2012 Stephen Gallagher <sgallagh@redhat.com> - 1.7-1.beta1
