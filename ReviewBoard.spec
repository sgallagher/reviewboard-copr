...
Patch2001: 0001-Create-new-sites-in-a-default-path.patch
...
# Create directory for default site installation
...
# Create default path for site installation
%attr(755,root,root) %dir %{_sharedstatedir}/reviewboard
%attr(755,root,root) %dir %{_sharedstatedir}/reviewboard/sites
